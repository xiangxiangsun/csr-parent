...
import csr.security.common.MessageConstant;
...
//    @PreAuthorize("hasAuthority('USER_QUERY')")
    ...
    @RequestMapping("/add")
    public Result add(@RequestBody csr.security.entity.SysUser user, Integer[] roleIds){
        try {
    ...
    public Result findById(Integer id){
        try {
            csr.security.entity.SysUser user = userService.findById(id);
    ...
    @RequestMapping("/edit")
    public Result edit(@RequestBody csr.security.entity.SysUser user , Integer[] roleIds){
        try {
